...
public class GcmMessage {
  ...
  public enum Type {
    ...
    KEYWORD_APPROVED, KEYWORD_REJECTED, KEYWORD_UPFOR_VOTE, PREMIUM_REJECTED,COMMENTED_REPLY, PREMIUM_APPROVED, PROFESSIONAL_APPROVED, PROFESSIONAL_REJECTED,LIKE,COMMENT
  }
